...
async function runEvolutionTests() {
  ...
  await testCase('Ponyta di Galar ➔ Rapidash di Galar', 10163, 40, 10164, 'Rapidash di Galar');
  await testCase("Farfetch'd di Galar ➔ Sirfetch'd", 10167, 28, 865, "Sirfetch'd");
  await testCase('Zigzagoon di Galar ➔ Linoone di Galar', 10171, 20, 10172, 'Linoone di Galar');
