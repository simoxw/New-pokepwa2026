...
export const POKEMON_FALLBACKS: Record<number, FallbackPokemonInfo> = {
  ...
  61: { name: 'Poliwhirl', types: ['water'], baseStats: { hp: 65, attack: 65, defense: 65, spAtk: 50, spDef: 50, speed: 90 }, moves: ['water-gun', 'hypnosis', 'bubble-beam', 'body-slam'] },
  62: { name: 'Poliwrath', types: ['water', 'fighting'], baseStats: { hp: 90, attack: 95, defense: 95, spAtk: 70, spDef: 90, speed: 70 }, moves: ['hydro-pump', 'dynamic-punch', 'submission', 'hypnosis'] },
  186: { name: 'Politoed', types: ['water'], baseStats: { hp: 90, attack: 75, defense: 75, spAtk: 90, spDef: 100, speed: 70 }, moves: ['hydro-pump', 'hyper-voice', 'bounce', 'perish-song'] },
